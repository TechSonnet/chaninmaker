...
public class InitClient {
    ...
    static final String CLIENT1_KEY_PATH = "src/main/resources/crypto-config/org1/cmtestuser1/SignKey.key";
    static final String CLIENT1_CERT_PATH = "src/main/resources/crypto-config/org1/cmtestuser1/SignCert.crt";

    static String CLIENT1_TLS_KEY_PATH = "src/main/resources/crypto-config/org1/cmtestuser1/TlsKey.key";
    static String CLIENT1_TLS_CERT_PATH = "src/main/resources/crypto-config/org1/cmtestuser1/TlsCert.crt";
